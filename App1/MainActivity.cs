...
namespace App1
{
    ...
    public class MainActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        public static string WebResult = null;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            #region ElemetPage
            Android.Widget.Button BtnOpenFolder = FindViewById<Android.Widget.Button>(Resource.Id.MainActivityBtnOpenFolder);
            Android.Widget.Button BtnOpenStart = FindViewById<Android.Widget.Button>(Resource.Id.MainActivityBtnStartTranslet);
            ...
            Android.Widget.Spinner SpierFrom = FindViewById<Android.Widget.Spinner>(Resource.Id.spinnerFrom);
            Android.Widget.Spinner SpierTo = FindViewById<Android.Widget.Spinner>(Resource.Id.spinnerTo);
            Android.Widget.ProgressBar progressB = FindViewById<Android.Widget.ProgressBar>(Resource.Id.progressBar1);
            ...
            BtnOpenStart.Click += async (s, e) =>
            {
                if (TxtOpenFolder.Text != "Unselected folder")
                {
                    ...
                    await SubTransletor_Class.SubTransleatAsync(TxtOpenFolder.Text);
